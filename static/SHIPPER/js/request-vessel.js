        ...
        // Form functions
        function resetForm() {
            document.getElementById('requestVesselForm').reset();
        }
        
        document.getElementById('requestVesselForm').addEventListener('submit', function(e) {
            e.preventDefault();
            
            // Get form values
            const vessel = document.getElementById('vesselSelect').options[document.getElementById('vesselSelect').selectedIndex].text;
